            ...
            <div className="border-t-3 flex md:flex-row xxs:flex-col xxs:items-center xxs:space-y-8 xxs:py-5 md:px-5 xxs:px-10 md:justify-evenly">
                ...
                <div className="flex flex-col items-center md:space-y-4 xxs:space-y-8">
                    ...
                    <div className="flex md:space-x-5 xxs:space-x-10">
                       {/* Facebook Link */}
                        <Link href="#" aria-label="facebook link icon" className="social-link-footer-icon" onClick={() => handleSocialLinkClick('facebook')}>
                        ...
                        {/* LinkedIn Link */}
                        <Link href="#" aria-label="LinkedIn link icon" className="social-link-footer-icon" onClick={() => handleSocialLinkClick('linkedin')}>
                        ...
                        {/* Twitter X Link */}
                        <Link href="#" aria-label="twitter x link icon" className="social-link-footer-icon" onClick={() => handleSocialLinkClick('twitter')}>
